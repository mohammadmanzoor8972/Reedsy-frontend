...
let BookService = class BookService {
    ...
    getBookList() {
        return this.http.get("http://localhost:3000/books").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((res) => res));
    }
    getBookbyId(slug) {
        return this.http.get(`http://localhost:3000/books/${slug}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((res) => res));
    }
};
